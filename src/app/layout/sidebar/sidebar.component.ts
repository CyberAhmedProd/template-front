...
@Component({
  ...
  template: `
    <nav class="sidebar">
      ...
      <div class="nav-section">
        <div class="nav-section-title">Gestion qualité</div>
        <a routerLink="/processus" 
           class="nav-item" 
           routerLinkActive="active">
          <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
  ...
  styles: [`
    ...
    .nav-item:hover { 
      background: var(--xl-green-hover); 
      color: var(--xl-green); 
    }

    .nav-item.active {
      background: var(--xl-green-xlight);
      border-left-color: var(--xl-green-mid);
      color: var(--xl-green);
      font-weight: 600;
    }
